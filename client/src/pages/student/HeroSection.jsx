          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:items-stretch">
            ...
            <div className="text-center lg:text-left space-y-6 sm:space-y-7 md:space-y-8">
              ...
              >
                ...
                Learn robotics step by step. Pick your grade, watch lesson videos, and build real skills at your own pace.
                ...
                <div className="flex flex-col items-start gap-3 sm:gap-4">
                  ...
                  <div className="w-full text-left">
                    ...
                    >
                      ...
                      Your robotics learning journey starts here with Robochamps LMS.
